 ...
 */
    ...
    //PM10 미세먼지 예보 정보를 표시할 창
public class FragmentB_A extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_b_a, container, false);
    ...
    public class GetMinuDustFrcstDspthTask extends AsyncTask<String, Void, String> {
                ...
                for(int i = 0; i < cnt; i++)
                {
                    ...
                    if(i==1)
                    {
                        for(int j = 1,a = 0; j<=3; j++,a++)
                        {
                            ...
                            System.out.println("A_ImageURL["+ j +"] : " + imgURL[a]);
                        }
                        ...
                        th_getBitmap.start();
                        th_getBitmap.join();
                        mImageView = (ImageView) getView().findViewById(R.id.img_a);
        ...
        String makeURL() {
            ...
            url.setInformCode("&informCode=pm10");
